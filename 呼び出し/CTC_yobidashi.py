...
def CTC(unit,wav_path,token_list,mean_std,model,config,recording_path):
    ...
    for n in range(outputs.size(0)):
        ...
        dictionary = ["じょうしょう","かこう","まえ","うしろ","みぎ","ひだり","りりく","ちゃくりく","すすむ","まがる","ひゃくせんちめーとる","にひゃくせんちめーとる","ゆっくり","はやく","ストリームオン","ストリームオフ","ちゅーがえり"]
        dictionary_phone = ["joushou","kakou","mae","usiro","migi","hidari","ririku","chakuriku","susumu","magaru","hyakusenchimeetoru","nihyakusentimeetoru","yukkuri","hayaku","sutoriimuon","sutoriimuofu","chuugaeri"]
        dictionary_char = ["上昇","下降","前","後ろ","右","左","離陸","着陸","進む","曲がる","100cm","200cm","ゆっくり","早く","ストリームオン","ストリームオフ","宙返り"]
        dict = []
        distance_bet_wards = []
        time = []
        parts = []
