...
def DP_search(file_name):
    path = "/Users/abechika/utm_shere/project/DroneAPP/backend/dataset/"
...
def DP_ans(file_name):
    path = "/mnt/utm-shared/project/dataset/"
    #print("testfile:",file_name)  
...
"""
def DP_ans(file_name,waveforms, labels):
    path = "/Users/abechika/utm_shere/project/DroneAPP/backend/dataset/"
...
if __name__ == "__main__":
    ...
    DP_search("received_audio.wav")
    print("!!")
    print(DP_ans("received_audio.wav",waveforms,labels))
